    ...
    return (
        <div className="flex flex-col items-center justify-center w-screen">
            <div className="flex flex-col items-center">
                <span className="xl:-mt-[700px] md:-mt-[600px]"><AnimationComponent status={'user'} /></span>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center mt-10 space-y-4 md:space-y-0 md:space-x-8">
                <button
                    className="flex flex-col items-center space-y-2 p-4 bg-blue-600 text-white rounded-lg shadow-md"
                ...
                <button className="flex flex-col items-center space-y-2 p-4 bg-blue-600 text-white rounded-lg shadow-md"
